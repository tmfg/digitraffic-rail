...
public class CompositionControllerTest extends MockMvcBaseTest {
    ...
    public void versionSearchShouldWorkOver1000() throws Exception {
        ...
        assertLengthAndVersion(StringUtil.format("/compositions?version={}", version1000), 2000, version2000, version2000); // returns version2000 only as it has over 1000 items
        assertLengthAndVersion(StringUtil.format("/compositions?version={}", version2000), 900, version900, version900); // returns version900
