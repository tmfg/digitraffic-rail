...
public class LastUpdateService {
    ...
    public enum LastUpdatedType {
        TRAINS, COMPOSITIONS, ROUTESETS, TRAIN_RUNNING_MESSAGES, TRAIN_LOCATIONS, FORECASTS, LOCALIZATIONS, OPERATORS, TIME_TABLE_PERIODS, TRAIN_RUNNING_MESSAGE_RULES, TRACKSECTIONS, GTFS, FUTURE_TRAINS, OLD_TRAINS, STATIONS, CATEGORY_CODES, TRACK_WORK_NOTIFICATIONS;
    }
