...
import static fi.livi.rata.avoindata.updater.service.ruma.RemoteTrackWorkNotificationService.RUMA_API_PAGE_SIZE;
    ...
    protected void update() {
        ...
        do {
            ...
            if (statusesResp.length == 0) {
                log.info("Reached end of track work notification paging, discontinuing");
                return;
            } else {
                log.info("Received {} track work notification statuses", statusesResp.length);
            }
