...
public class WebClientConfiguration {
        ...
        public HttpClient defaultHttpClient(
                        final @Value("${updater.http.connectionTimoutMillis:30000}") long connectionTimeOutMs,
                        @Value("${updater.validate-ripa-cert:true}") final boolean validateRipaCertificate)
                        throws SSLException {
                /*
                 * SSL certificate validation needs to be disabled locally for the application
                 * to be able
        ...
        public WebClient webClient(final HttpClient defaultHttpClient,
                ...
                return WebClient.builder()
                                ...
                                .exchangeStrategies(ExchangeStrategies.builder()
                                                ...
                                                .codecs(codecs -> codecs
                                                                .defaultCodecs().jacksonJsonDecoder(
