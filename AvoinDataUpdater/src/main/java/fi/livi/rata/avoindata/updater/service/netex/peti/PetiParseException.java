 ...
 * skipped. By failing fast here, the caller (the PETI fetch/refresh step) can keep the last-good cached
 * snapshot instead of overwriting it with partial or empty data, preventing a mixed/degraded state downstream.
 */
